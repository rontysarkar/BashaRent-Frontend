    ...
    <div>
      ...
      <div className="mt-6 border-t pt-5">
        ...
        <div className="grid grid-cols-3 gap-2">
          <Button
            onClick={() => {onSubmit({email:"admin@gmail.com",password:"123456"})}}
            variant="outline"
          ...
          <Button
            onClick={() => {onSubmit({email:"landlord@gmail.com",password:"123456"})}}
            variant="outline"
            className="h-10 text-xs sm:text-sm"
          >
            Landlord
          ...
          <Button
            onClick={() => {onSubmit({email:"tenant@gmail.com",password:"123456"})}}
            variant="outline"
            className="h-10 text-xs sm:text-sm"
          >
            Tenant
